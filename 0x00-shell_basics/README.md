1. pwd command is just as the name suggest, to print out the path of the current working directory
...
6. ls -lan command is used to list all files, including hidden files numerically7. mkdir is the command used to creat a new directory
